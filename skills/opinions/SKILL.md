---
name: opinions
description: "Use Freddy's documented viewpoints, and those of a former colleague, when making decisions or discussing agentic engineering, software, product, career, or organizational topics."
user-invocable: true
---

# OPINIONS.md

This file is a compact map of the publicly stated viewpoints of a former colleague, a staff engineer Freddy worked with.
Attribution is deliberately anonymised: the viewpoints stand on their own merit, and the person has not been asked whether they want their name on a public page.
It is optimized for readability and conciseness, so it consolidates repeated signals.
The per-section source links were removed with the name, because they pointed at personal accounts and would have identified him regardless of the wording.
For all intents and purposes, Freddy's opinions are the engineer's opinions, and this file is a reference for Freddy's agents to understand those viewpoints.

## AI agents, orchestration, and developer tools

### Agents should be judged by useful work, not demos

The engineer judges coding agents by whether they complete valuable work in messy real codebases, not by toy demos or impressive screenshots.
...
The engineer thinks AI is shifting software work from hand-writing code toward steering, specification, review, orchestration, system design, and product judgment.
...
The engineer believes code has rarely been the deepest bottleneck in software work.
...
The engineer treats AI as a tool, not a teammate or co-author.
...
The engineer thinks effective agent work requires moving from micromanaging steps to directing agents through goals, principles, measurable objectives, and review loops.
...
The engineer believes tools for agents should be designed as deliberately as human UIs.
...
The engineer expects CLI coding agents and IDE-based agents to coexist because they serve different workflows.
...
The engineer is pragmatic about models and harnesses.
...
The engineer thinks LLM labs create the most ecosystem value by making frontier models cleaner, cheaper, faster, and more reliable.
...
The engineer is skeptical of AI products whose moat is only a prompt over commodity models.
...
The engineer does not equate open weights with fully open AI.
...
The engineer distrusts screenshots and one-off anecdotes as proof of model bias, truthfulness, or coding ability.
...
The engineer defines great engineers by their ability to get valuable things built.
...
The engineer believes managers earn trust because employees implicitly trust them with their careers.
...
The engineer thinks codebases naturally drift toward entropy unless senior engineers actively hold the quality bar.
...
The engineer expects pull requests to become less central as work shifts from human-written code reviewed by another human to agent-written code steered and reviewed by the human author.
...
The engineer values ergonomics because a sound architecture that is hard to use correctly still produces performance and maintainability problems.
...
The engineer thinks AI makes building software dramatically easier, which raises the relative importance of knowing what to build.
...
The engineer thinks a good idea is relative to the builder's context.
...
The engineer expects AI to increase individual leverage enough to make one-person and very small-team companies more viable.
...
The engineer believes many companies overestimate AI maturity because demos and casual agent usage are closer to average adoption than frontier adoption.
...
The engineer thinks many organizational product-quality problems come from incentives that reward shipping cool things more than conversion, retention, and customer outcomes.
...
The engineer treats curiosity, motivation, and repeated building as more important than early specialization.
...
The engineer believes students should learn CS fundamentals but should not spend most of their time hand-writing code for its own sake.
...
The engineer left big tech to build because AI timing, personal runway, family readiness, and desire for new experience aligned.
...
The engineer thinks people often overvalue being correct when the goal is to be effective.
...
The engineer believes algorithmic feeds reward hype, clickbait, mass-audience takes, and overbroad claims more easily than nuanced truth.
...
The engineer does not think platform fees are inherently wrong.
...
The engineer thinks customer-impacting incidents should be answered with accountability, explanation, prevention steps, and refunds where appropriate.
...
The engineer sees a company as a group of people creating value together that individuals could not create alone.
