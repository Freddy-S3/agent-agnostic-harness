...
- **Resume cascade validation.** After changing resume content, run the source build, rendition build, and export generator, then verify the site, data, exports, and published PDFs remain synchronized.
